namespace WarehouseSystem.Common.Constants
{
   public static class ExceptionMessages
    {
        public const string InvalidNameVessel = "Please insert name of the vessel!";
        public const string InvalidVoyageVessel = "Please insert voyage of the vessel!";
        public const string InvalidNameOfForwarder = "Please insert name of the forwarder!";
        public const string InvalidDateOfArrival = "Please insert date of the arrival!";
        public const string InvalidId = "Please insert correct id!";
        public const string InvalidTruckRegistrationNumber = "Please insert correct registration number of the truck!";
        public const string InvalidTrailerRegistrationNumber = "Please insert correct registration number of the trailer!";
        public const string InvalidFirstName = "Please insert first name!";
